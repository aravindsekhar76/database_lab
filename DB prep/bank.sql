...
select customer_name from customer where customer_street='City Gardens' and customer_city='Kollam';

select branch_name from account where account_number in (
select depositor.account_number from depositor where depositor.customer_name in(
select customer.customer_name from customer where customer_street='Harrison')
);

select customer.customer_street,customer.customer_name,borrower.loan_no from customer inner join borrower on customer.customer_name=borrower.customer_name;